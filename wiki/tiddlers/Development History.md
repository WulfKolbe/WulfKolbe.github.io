...
Unfortunately the Claude CLI and Claude.ai deviated from my plans and took of into Python to generate the complete project. Only the drillui_bridge is a bun based Typescript web page. I have never touched the code myself. My task was only to shout and scream at the constantly cheating Claude CLI's and do provide some test data.
